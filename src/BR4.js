  ...
  render() {
    return (
      <div className="BLogin">
        ...
        <big>
          <big>
            <h1 style={{ color: "#111111" }}>What's your business about?</h1>
          </big>
        </big>
        ...
        <br></br>
        <TextArea
          placeholder="This will show up for consumers to see, so make it good! Keep it short and sweet, interesting for customers."
          style={{
            minHeight: 300,
            height: 50,
            fontSize: 20,
        ...
        />
        <br></br>
        <button className="btn" onClick={this.onClickBR5}>
