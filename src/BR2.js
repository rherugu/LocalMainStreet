  ...
  render() {
    return (
      <div className="B2Login">
        ...
        <big>
          <big>
            <h1 className="mtitle" style={{ color: "#111111" }}>
              What's your email?
            </h1>
          </big>
        </big>
        ...
        <div className="mtitle">
          ...
          />
          <br></br>
          <button className="btn1" onClick={this.onClickBR3}>
            <span>Click to move on!</span>
          </button>
          <button className="btn22" onClick={this.onClickHome}>
